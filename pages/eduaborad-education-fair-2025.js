              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <motion.section className="relative py-6 sm:py-8 md:py-12 mb-6 sm:mb-8 md:mb-12" {...fadeIn}>
                  <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start">
                    ...
                    >
                      <motion.div
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-[#a61d31] to-[#C82333] text-white px-3 py-1.5 rounded-full text-sm font-semibold mb-4 w-fit"
                        variants={fadeIn}
                      >
                      ...
                      <motion.div className="space-y-4 mb-6" variants={staggerChildren}>
                        ...
                        >
                          ...
                          <p className="text-base font-medium text-gray-800">
                            Same-Day Offer Letters* from Top Global Universities
                          </p>
                        </motion.div>
                    ...
                    {/* Right side - Enhanced Enquiry Form */}
                    <motion.div
                      className="bg-white/95 backdrop-blur-sm p-4 sm:p-6 md:p-8 rounded-3xl shadow-2xl w-full border border-white/20 relative overflow-hidden"
                      id="form"
                      variants={fadeIn}
                    >
            ...
            <motion.section className="text-center" {...fadeIn}>
              <div className="bg-gradient-to-br from-white via-gray-50 to-white p-4 sm:p-6 md:p-8 lg:p-10 rounded-3xl shadow-2xl border border-gray-100 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <motion.div className="text-xs text-gray-600 space-y-1 mb-6" variants={fadeIn}>
