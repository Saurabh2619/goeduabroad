        ...
        <div className="w-full">
          ...
          <div className="bg-gradient-to-br from-[#FFE4E6] via-[#FFF0F1] to-[#FFE4E6] w-full relative overflow-hidden">
            ...
            <div className="w-full relative z-10">
              ...
              <div className="w-full">
                <img
                  src="https://res.cloudinary.com/duyo9pzxy/image/upload/v1751539628/Education_banner_01_erclnp.jpg"
                  ...
                  <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start">
                    ...
                    >
                      ...
                      <motion.div className="space-y-4 mb-6" variants={staggerChildren}>
                        ...
                        >
                          <div className="bg-[#a61d31]/10 p-1.5 rounded-lg flex-shrink-0">
                            <Star className="text-[#a61d31] w-5 h-5" />
                          </div>

                          <p className="text-base font-medium text-gray-800">For select universities only</p>
                        </motion.div>
                        ...
                        >
                          <div className="bg-[#a61d31]/10 p-1.5 rounded-lg flex-shrink-0">
                            <GraduationCap className="text-[#a61d31] w-5 h-5" />
                          </div>

                          <p className="text-base font-medium text-gray-800">
                            On-the-spot offers subject to eligibility and document review
                          </p>
                        </motion.div>
                      </motion.div>
