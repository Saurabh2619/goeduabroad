...
<input name={"city"} className={styles.input} placeholder={"Enter your City"} maxLength={20} type={"text"} value={formData && formData.city} onChange={(e)=>{setFormData(res=>({...res,city:removeNumbers(e.target.value)})) }}/>
