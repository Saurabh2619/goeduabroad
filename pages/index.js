...
export default function Home({ datac, datad, posts }) {
  ...
  const whyus = [
    {
      ...
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/v1680129484/manager-office-190723_1_keg50f.webp",
    },
    {
      title: "One-one-One Mentorship Sessions",
      image:
        "https://www.gettingsmart.com/wp-content/uploads/2020/10/Mentorship-.jpg",
    },
    {
      title: "Mentored by Experienced Professionals",
      image:
        "https://img.freepik.com/free-photo/successful-happy-business-team_53876-20936.jpg?w=2000",
    },
    {
      title: "Find what's right fit for you",
      image:
        "https://s3.us-east-1.amazonaws.com/co-assets/assets/images/_fbTw/pricing-models.jpg",
    },
    {
      title: "24x7 Support",
    ...
    },
    {
      ...
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/v1680129484/How-to-Quickly-Understand-Mathematical-Ideas-in-Just-Three-EASY-STEPS_1_ujjivt.webp",
    },
  ];
  const slides2 = [
    {
      ...
      image:
        "https://fmipa.um.ac.id/wp-content/uploads/2015/11/team-1-200x200.jpg",
      collegeimage: "/1.png",
    },
    {
      title: "Mr.Rosewood",
    ...
    },
    {
      ...
      image:
        "https://fmipa.um.ac.id/wp-content/uploads/2015/11/team-1-200x200.jpg",
      collegeimage:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_127,q_15/v1680135246/harvard_ajtss6.webp",
    },
  ];
  ...
  const herocountries = [
    {
      title: "USA",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_fill,h_44,w_44/v1680132882/us_qsodyv.webp",
      color: "skyblue",
    },
    {
      title: "UK",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_fill,h_44,q_10/v1680132881/uk_elgshi.webp",
      color: "skyblue",
    },
    {
      title: "Canada",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_44,q_10/v1680132882/circle-flag-of-canada-free-png_v9rzo9.webp",
      color: "skyblue",
    },
    {
      title: "Australia",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_fill,h_44,q_10,w_44/v1680132881/aus_poai3u.webp",
      color: "skyblue",
    },
    {
      title: "New Zealand",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_fill,h_44,q_10,w_44/v1680132881/Flag-New-Zealand_lgl97e.webp",
      color: "skyblue",
    },
    {
      title: "Ireland",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_44,q_10,w_44/v1680132881/FLAG-Ireland_mezg2t.webp",
      color: "skyblue",
    },
    {
      title: "Singapore",
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_fill,h_44,q_10,w_44/v1680132987/4320px-Flag_of_the_President_of_Singapore.svg_m5wp3u.webp",
      color: "skyblue",
    },
  ];
  ...
  const partners = [
    ...
    {
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/v1680129484/mcgill_1_wqwwzt.webp",
      image2:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_127,q_15/v1680135246/harvard_ajtss6.webp",
  ...
  const countries = [
    {
      ...
      stars: 4,
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/v1680129484/shutterstock_1025960785-2560x1300_1_suhk9z.webp",
    },
    {
      title: "Canada",
      description:
      ...
      stars: 4,
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_1423,q_31/v1680135399/canada_w23oxt.webp",
    },
    {
      title: "UK",
      description:
      ...
      stars: 4,
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_726,q_23/v1680135059/London_Big_Ben_Phone_box_drho2j.webp",
    },
    {
      ...
      stars: 4,
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/v1680129484/photo-1471306224500-6d0d218be372_1_ayi7ff.webp",
    },
  ];
  const authorities = [
    {
  ...
  const fea = [
    ...
    },
    {
      ...
      description:
        "For me who has no one in family ever been to USA getting admission to US university seems like an arduous and impossible task before we came in touch with Abhishek. He helped me from preparing for SAT to getting accommodation after I got admission. He helped me in all the steps of the process and continue to help with internship search using his networks of contacts in USA. I got admission in 6 schools out of 7 I applied, I got scholarship from 3 Universities. Currently, I am studying at University of Buffalo that offered me $48,000 scholarship.",
      stars: 5,
      image: "/r2.jpg",
  ...
  const results = [
    {
      title: "Bhavya Mishra",
      description:
        "I am thankful to the team EduAbroad specially Dr. Swati Mishra. Dr. Swati always motivated me and all other students to work hard and stay focused. The faculty at EduAbroad is very hard working and it made my dream come true. Proud to be student of EduAbroad.",
      stars: 4,
      image: "/r3.jpg",
    ...
    },
    {
      ...
      description:
        "Mentors at EduAbroad are extremely dedicated and hard working. They make it a point for every student to be equally interactive in the training sessions. Mock interviews by experts from industry helped a lot.",
      stars: 4,
      image: "/r4.jpg",
    ...
    },
    {
      ...
      description:
        "I would like to thank all the mentors of EduAbroad who helped me throughout my journey. They helped me by motivating me and getting all my doubts clear. They helped me in clearing all my concepts. The study materials of EduAbroad are very helpful and beneficial and the practice questions are of the level of actual IELTS exam.        ",
      stars: 4,
      image: "/r5.png",
    ...
    },
    {
      title: "Anannya",
      description:
        "My experience with EduAbroad was truly memorable, the team was extremely supportive. They always made sure that all my doubts were cleared. It is for them that I have reached where I am now.",
      stars: 5,
      image: "/r6.jpg",
    ...
    },
    {
      ...
      description:
        "I learned a lot of tips and tricks at EduAbroad which were really game changing and it boosted my perspective of learning along. Those little things are the key factors which help students like me achieve the goals.              ",
      stars: 4,
      image: "/r10.jpg",
  ...
  const universities = [
    {
      ...
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_775,q_22/v1680131251/camb_zlhcfl.webp",
    },
    {
      ...
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_691,q_19/v1680131252/harvard_fqewnf.webp",
    },
    {
      title: "John Hopkins",
      description:
      ...
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_1121,q_47/v1680131252/hopkins_erwtfv.webp",
    },
    {
      title: "MIT",
      description:
      ...
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_738,q_37/v1680131080/mit_vauoak.webp",
    },
  ];
...
},
{
  ...
  const sendLead = async (leadData) => {
    ...
    if (!firstname || !phone || !email) {
      throw new Error(
        "Missing required fields: firstname, phone, and email are required.",
      );
    }
  ...
  const marqueeContent = (
    <>
      <img src="/camblog.svg" width={120} /> OFFICIAL CAMBRIDGE LEARNING PARTNER
    </>
  );
      ...
      <DefaultLayout scroll={300}>
        ...
        {thankyou ? (
          <div className={styles.modaloverlay}>
            <div className={styles.modal}>
              ...
              <p>
                Our Executive will get back to you shortly meanwhile you can
                browse our website or apply for more services or preparation
                plans.
              </p>
              <div>
                <a
                  onClick={(e) => {
                    (e.preventDefault(), setThankYou(false));
                  }}
                >
                  Browse More
                </a>
        ...
        <div className={styles.hero}>
          <video
            muted
            playsInline="true"
            poster="https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,h_600,q_29/v1680131427/vidpost_v3pyun.jpg"
            autoplay="true"
            loop="true"
          >
            <source src="/v3_comp.mp4" />
          </video>
          <div className={styles.mask}></div>
          <div className={styles.content + " font-semibold"}>
            <h2>
              <span className="b1">Get Your Dream </span>
              <br />
              University 
            </h2>
            ...
            <div className={styles.getstarted}>
              ...
              <button
                onClick={() => {
                  submitGetStarted(getstarted);
                  window.location.href = "https://app.goeduabroad.com/";
                }}
              >
                {loading ? (
                  <svg
            ...
            <div className={styles.top}>
              ...
              <div className={styles.conts}>
                {herocountries &&
                  herocountries.map((i, d) => {
                    return (
                      <div className={styles.cont}>
                        <img alt={i.title} src={i.image} /> <p>{i.title}</p>
                      </div>
                    );
                  })}
              </div>
        ...
        >
          ...
          <div className={styles.who}>
            <div className={styles.col1}>
              <p>
                EduAbroad is founded by former Professor of IIM Lucknow, Dr.
                Swati Abhishek Mishra. She holds a Master’s in Management in a
                joint program with University of Cambridge and Massachusetts
                Institute of Technology, and a PhD. in Strategy and Marketing
                from University of Cambridge. She was the winner of ……… Read
                More on About Page
              </p>
              <Link href={"/about"}>
                <button className={styles.mainbutton}>Open About Page</button>
              </Link>
            </div>
            <div className={styles.col2}>
              <ResponsiveIFrame src="https://www.youtube.com/embed/W7rKLNk4FMU" />
            </div>
          </div>
        </Section>
        <div className={styles.partner}>
          ...
          <div className={styles.partnertext}>
            ...
            <img src="/camnew.svg" width={220} className={styles.camblogo} />
          </div>
        </div>
          ...
          <div className={styles.featured}>
            ...
            <Marquee speed={80}>
              {Array(10)
                ...
                .map((i, d) => {
                  return (
                    <img src={`/c${d + 1}.png`} className={styles.newslogo} />
                  );
                })}
              {Array(10)
                .fill()
        ...
        >
          <Swiper
            ...
            spaceBetween={
              mobile === "mobile" ? 30 : mobile === "tablet" ? 30 : 10
            }
            slidesPerView={
              mobile === "mobile" ? 1 : mobile === "tablet" ? 2 : 4
            }
            loop={true}
            loopedSlides={5}
            autoplay={true}
        ...
        <Section
          title={`Top Countries of ${getCurrentYear()} to : Study Abroad`}
          align="center"
          color="var(--brand-col1)"
        >
          <Swiper
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <g id="Layer_1-2">
                                    <polygon
                                      class="cls-1"
                                      points="9.42 0 12.33 5.9 18.85 6.85 14.13 11.44 15.25 17.92 9.42 14.86 3.6 17.92 4.71 11.44 0 6.85 6.51 5.9 9.42 0"
                                    />
                                  </g>
                                </svg>
                              );
  ...
  <div className={styles.circle}><img src='/gras.png'/></div>
                  ...
                  <SwiperSlide key={i}>
                    <div className={styles.rcard}>
                      ...
                      <div class={styles.cardcontent}>
                        ...
                        <p>{i.description}</p>
                        {i.video ? <ResponsiveIFrame src={i.video} /> : ""}
                        <div
                          className={
                            styles.stars +
                            " flex flex-row items-center justify-start"
        ...
        <Section title="Mentors" align="center" color="var(--brand-col1)">
          <Swiper
            modules={[Navigation, Pagination, Autoplay]}
            spaceBetween={
              mobile === "mobile" ? 30 : mobile === "tablet" ? 30 : 70
            }
            slidesPerView={
              mobile === "mobile" ? 1 : mobile === "tablet" ? 2 : 4
            }
            ...
            {mentors &&
              mentors.map((item, index) => (
                <SwiperSlide key={index}>
                  <Link href={`/mentor/${item.slug}`}>
                    {" "}
                    {/* Replace with item.id if needed */}
                    <div
  ...
  <div className={styles.university}><img src={i.image}/><p>{i.title}</p></div>
        ...
        <div className={styles.formhold} id="expert">
          <div className={styles.formcontent}>
            <h1>
              Kickstart your Career Journey in your
              <br />
              <span>Dream Country Abroad.</span>
            </h1>
          ...
          <div className={styles.formcont}>
            <h1 className={styles.team_heading}>
              Plan your Career in Abroad with<strong> EduAbroad</strong>.
            </h1>
            <input
              name={"name"}
              className={styles.input}
            ...
            <CustomSelect
              ...
              z={9}
              full="true"
              defaultText="Select your Goal"
              noPadding={true}
              objects={goals}
              setSelect={(r) => {
                setFormData((res) => ({ ...res, goal: r }));
              }}
            />
            {formData &&
            formData.fullname &&
...
export async function getServerSideProps(context) {
  const [datac, datad, po] = await Promise.all([
        ...
        <div className="flex font-sans flex-col md:flex-row items-center gap-6 relative overflow-hidden shadow-xl shadow-gray-600/10 rounded-3xl min-h-[60vh] sm:min-h-[40vh] bg-[#A51C30] p-8">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-white/90 md:text-lg">
              Career Aptitude Test for students from 10th to 12th, graduates &
              professionals
            </p>
