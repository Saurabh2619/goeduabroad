...
function cronberryTrigger(username, u_email, u_mobile, u_year, u_city, linke,eprogram) {
  ...
  var data = JSON.stringify({
      ...
      "paramList": [{
          ...
          {
              "paramKey": "formname",
              "paramValue": router?.query?.source ?? "EduAbroad AP Webinar Page"
          },
          {
            "paramKey": "program",
            "paramValue": eprogram
...
source:router?.query?.source  ?? 'AP Webinar Abroad Page'
    }).select();
...
<div className={styles.divider2}>
  <Image width={"300"} height={"800"} alt='Student holding SAT Exam Books' src='/student.png'/>
        ...
        <img className={styles.heroimage} src='/crackwebinar.jpg'/>
