...
function Post({ data, datac }) {
  ...
  const handleShare = (platform) => {
    ...
    const title = `${final?.title} | goEduabroad.com`
    const description = final?.metaDesc || final?.intro || "Expert study abroad guidance and insights"

    switch (platform) {
      case "twitter":
        const twitterText = `${title}\n\n${description}\n\n#StudyAbroad #Education #goEduabroad`
        window.open(
        ...
        break
      case "facebook":
        // Facebook will automatically fetch Open Graph data including image and title
        window.open(
        ...
        break
      case "linkedin":
        // LinkedIn will use Open Graph data for rich preview with image
        window.open(
...
{/* Related posts - Enhanced mobile layout */}
        ...
        <div className="mt-14 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-12 mb-8 sm:mb-12 shadow-2xl relative overflow-hidden">
