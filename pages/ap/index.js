        ...
        <div className="w-full">
          <div className="bg-[#FFE4E6] w-full">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.section className="relative py-16 flex flex-col lg:flex-row items-center gap-8" {...fadeIn}>
                <div className="flex-1 text-left z-10">
                  <h1
                    className="my-20 text-5xl md:text-6xl font-bold leading-tight text-gray-900 mb-6"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    Boost Your <span className="text-[#A51C30]">Scholarship</span> and{" "}
                    <span className="text-[#A51C30]">Admission</span> Chances with{" "}
                    <span className="text-[#A51C30]">AP</span>
                  </h1>
                  ...
                  <motion.button
                    className="mt-8 px-8 py-4 bg-[#A51C30] text-white font-semibold rounded-full text-lg hover:bg-opacity-90 transition-colors duration-300 shadow-lg"
                ...
                <div className="flex-1">
                  <img
                    ...
                    alt="Students studying for AP exams"
          ...
          <div className="my-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> {/* Update 1 */}
            <motion.section
              className="bg-gradient-to-r from-[#A51C30] to-[#C82333] text-white p-8 sm:p-12 rounded-3xl shadow-2xl mb-24 w-full\"
              {...fadeIn}
            >
            ...
            <motion.section className="mb-24 bg-gray-50 p-8 rounded-3xl shadow-xl" {...fadeIn}>
              ...
              <div className="grid gap-8 md:grid-cols-2">
                {[
                  ...
                  <motion.div
                    key={index}
                    className="bg-white p-6 rounded-2xl shadow-lg border-2 border-[#A51C30] hover:shadow-2xl transition-shadow duration-300"
                    whileHover={{ scale: 1.03 }}
                  >
                    <h3 className="text-xl font-semibold text-[#A51C30] mb-2">{item.week}</h3>
                    <p className="text-lg text-gray-700">{item.dates}</p>
                  </motion.div>
                ))}
              </div>
              <p className="mt-8 text-base text-gray-700 text-center">
              ...
              <div className="grid gap-8 md:grid-cols-3">
                {[
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    <div className="text-[#A51C30] mb-4">
            ...
            <motion.section
              className="text-center bg-gradient-to-r from-[#A51C30] to-[#C82333] text-white p-8 sm:p-12 rounded-3xl shadow-2xl"
              {...fadeIn}
            >
              ...
              <p className="text-lg leading-relaxed mb-6 max-w-3xl mx-auto">
                AP courses are more than a way to earn college credit. They help you develop skills that will be useful
                in college and beyond. You learn how to think critically, manage time effectively, and handle
                challenging coursework. These are the same skills that will support you in higher education and future
                careers.
              </p>
              ...
              <motion.button
                className="px-8 py-3 bg-white text-[#A51C30] text-lg font-semibold rounded-full hover:bg-opacity-90 transition-colors duration-300 shadow-lg"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                Learn More About AP
