      ...
      <>
        {process.env.NEXT_PUBLIC_SITE_LIVE == "true" ?
          ...
          <div>
            ...
            <p>Please contact your cloud hosting provider to resolve the issue.</p>
          </div>}
      </>
    </>
  )
