...
export default function Component() {
  ...
  const teachers = [
    ...
    },
    {
      ...
      description: (
        <p>
          Over 15 years of experience in guiding and training 1500+ students on their IELTS journey and abroad
          applications.
          <br /> Consistently helping students achieve IELTS scores of 7+ bands. <br />
          Expertise in securing admissions and scholarships at top universities such as Boston University, UCL, LBS, and
          Warwick.
          <br /> Successfully helped students secure scholarships worth ₹4 crore+.
        </p>
      ),
    },
    {
  ...
  const faqItems = [
    {
      ...
      answer:
        "One should start preparing for the SAT exam immediately after class 10th board exams. Take the diagnostic test to assess where you stand currently.",
    },
    {
      question: "Will I get practice questions?",
      answer:
        "You can practice through the questions available in the online portal. There are 2500+ questions to solve.",
    },
    {
      question: "Will I get practice mocks?",
      answer:
        "Yes. Every student who enrolls with us for SAT Online Classes gets 5 Original official style mock tests as a part of the program.",
    },
    {
      question: "What if I have any query regarding the program?",
      answer:
        "You can speak to a counsellor regarding any query related to SAT by registering on this page. You can also mail your queries to info@eduabroad.com",
    },
  ]
  const features = [
    {
  ...
  return (
    <>
      ...
      <Navbar className="bg-white font-sans border-b border-gray-200" maxWidth="2xl">
        ...
        <NavbarContent className="hidden sm:flex gap-4" justify="end">
          <NavbarItem className="flex items-center">
            ...
            <Link href="tel:+919044442989" className="mr-4">
              +91 904 444 2989
            </Link>
          </NavbarItem>
        </NavbarContent>
      ...
      <div className="flex font-sans py-2 sm:py-12 bg-blue-500 overflow-hidden relative" id="form">
        <img
          src="https://www.universityofcalifornia.edu/sites/default/files/styles/feature_banner_image/public/2022-01/2018_03_12_UCR_day1_post-79.jpg?h=0c170278&itok=6dn4jQxG"
          className="w-full h-full left-0 top-0 opacity-20 mix-blend-luminosity absolute object-center object-cover"
        />
        <div className="container mx-auto w-full flex flex-col md:flex-row items-center justify-center">
          <div className="flex-1 p-8 text-white z-10">
            ...
            <p className="text-xl mb-6">Personalized program to help you achieve your target SAT® score!</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => (
              <Card shadow="none" key={index} className="border font-sans border-gray-200">
                ...
                <CardFooter
                  className={`${feature.bgColor} ${feature.textColor} p-4 flex aspect-auto sm:aspect-square flex-col items-center justify-center`}
                >
