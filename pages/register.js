...
export default function Home() {
  ...
  const slides = [
    ...
    {
      image:
        "https://res.cloudinary.com/dbnrwsxj1/image/upload/c_scale,w_1968/v1716228530/cambridgecreative_wyp0ja.webp",
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "EduAbroad has an experienced team of international experts who’ve been helping students to pursue their dreams of studying abroad. Most of these students are international students thus we can help you with end-to-end assistance from the application process to accommodation.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "On successful completion of enrolment process, students receive a EduAbroad Zoom ID & password to join EduAbroad live platform and to attend live, online classes.",
    },
    {
  ...
  function setNotification(de) {
    ...
    const id = setTimeout(() => {
      setNotificationText(), setTimeoutId(null)
    }, 2500)
    setTimeoutId(id)
  }
  useEffect(() => {
  ...
  const features = [
    <>
      Complete<span className={styles.blue}>&nbsp;Assistance</span>
    </>,
    <>
      Mentoring by<span className={styles.blue}>&nbsp;Experienced Professionals</span>
    </>,
    <>
      Dedicated IELTS<span className={styles.blue}> Course</span>
    </>,
    <>
      Properly Planned <span className={styles.blue}> Career Guidance</span>
    </>,
  ]
            ...
            <div className={styles.c1}>
              ...
              <div className={styles.hold}>
                ...
                <p>
                  Admissions
                  <br />
                  <span className={styles.numbers}>{Math.floor(students / 3)}</span>
                </p>
                <p>
                  Hours Served
                  <br />
                  <span className={styles.numbers}>{students * 3}</span>
                </p>
              </div>
              <div>
                <div className={styles.progress}>
                  <div
                    ...
                    style={{ width: formData ? (Object.keys(formData).length * 100) / 5 + "%" : "0%" }}
                  >
                    <p>Form Progress : {formData ? (Object.entries(formData).length * 100) / 5 + "%" : "0%"}</p>
                  </div>
            ...
            <div className={styles.c2}>
              <div className={styles.formcont}>
                <h1 className={styles.team_heading}>
                  Fill out the form to Schedule a FREE Consultation with our Expert.
                </h1>
                <input
                  name={"name"}
                  maxLength={40}
                ...
                <input
                  ...
                  className={
                    styles.input +
                    " " +
                    (validateEmail(formData ? formData.email : "test@gm.co") ? "" : styles.fielderror)
                  }
                ...
                <input
                  ...
                  className={
                    styles.input +
                    " " +
                    (validatePhone(formData ? formData.phone : "+918888888888") ? "" : styles.fielderror)
                  }
                ...
                <CustomSelect
                  z={9}
                  full="true"
                  defaultText="When are you planning to move abroad for Studies?"
                  noPadding={true}
                  objects={years}
                  setSelect={(r) => {
                ...
                />
                {formData && formData.city && formData.fullname && formData.phone && formData.email && formData.year ? (
                  ""
                ) : (
          ...
          <Section title={"Words by: Our Students"} color="var(--brand-col1)" align="left">
            <div className={styles.parent}>
              <div className={styles.col1}>
                ...
                <p>
                  Our students are thrilled with the classes that we offer. They consistently express their satisfaction
                  with the quality of the instruction, the engaging curriculum, and the supportive learning environment.
                  They appreciate the individualized attention that they receive from our dedicated teachers, and they
                  are making steady progress in their studies. Overall, our students are incredibly happy with the
                  education that they are receiving, and it shows in their enthusiasm and dedication to their studies.
                </p>
	...
	<li>Overall, our students are extremely satisfied with the education that they are receiving, and we are continually working to improve and enhance the learning experience for all of our students.</li>
              ...
              <div className={styles.col2}>
                <div className={styles.yt}>
                  <YouTube className="embed-container" title="" videoId="3erxXGVy08Y" opts={opts} />
                </div>
              </div>
            </div>
          </Section>
                ...
                mentors.map((i, d) => {
                  return (
                    <div className={styles.card}>
                      ...
                      <Image width={"100"} height={"100"} alt={i.fullname} src={i.image || "/placeholder.svg"} />
                      <h2>{i.fullname}</h2>
                      {i.collegeimage ? (
                        <Image
                          width={"100"}
                          height={"20"}
                          alt={i?.collegealt || i.fullname}
                          className={styles.colimg}
                          src={i.collegeimage || "/placeholder.svg"}
                        />
                      ) : (
                        ""
                      )}
          ...
          <Section color="var(--brand-col1)" align="left">
            <h2 className={styles.heading}>
              Why choose EduAbroad <br />
              <span className={styles.red}>as your IELTS coaching partner?</span>
            </h2>
            <div className={styles.list}>
              <p>•EduAbroad is the one stop destination for you if you want to ace the IELTS exam.</p>
              <p>
                •We are the official learning partners of the University of Cambridge currently serving at Lucknow,
                Delhi, Mumbai, Kanpur, Indore and Nagpur.
              </p>
              <p>
                •Therefore, you get books and portal containing mock tests exclusively from the University of Cambridge
                and best-in-class IELTS coaching material which prepare you for your IELTS exam.
              </p>
              <p>
                •We have the best faculty in India trained directly by Cambridge University for IELTS coaching and we
                have a dedicated team specially for preparing students for IELTS and also assisting them in their study
                abroad jounrey further - right from application, SOP, CV to helping students in getting scholarship &
                financial aid, getting accommodation, travel assistance and visa assistance.{" "}
              </p>
              <p>
                •We understand that cracking IELTS is the most crucial aspect for any student who has to pursue their
                dream of studying abroad.
              </p>
              <p>
                •Our students get the golden opportunity to get invaluable insights from our renowned mentor & founder
                Dr. Swati Mishra, an alumna of the University of Cambridge and MIT, USA, and a former IIM Lucknow
                Professor, which helps them to overcome every challenge in their way with utmost ease.{" "}
              </p>
              <p>
                •With EduAbroad by your side, there is no stopping until you reach your dream university! Join us now to
                get the best IELTS coaching to turn your study abroad dreams into reality.
              </p>
            </div>
          </Section>
